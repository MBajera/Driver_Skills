...
from driver_app.views import AdviceAPIView, AnswerAPIView, AnswerDetailsAPIView, AdviceDetailsAPIView, \
    QuestionAPIView, QuestionDetailsAPIView,TrainingDetailsAPIView, TrainingAPIView,  TagViewSet, UserViewSet, \
    CheckTraining
